...
class NicoAndroidElement(NicoElement):
    def __init__(self, **query):
        self.query = query
        super().__init__(**query)
        self.running_info = RunningInfo(self.udid)
    ...
    @property
    def id(self):
        return self._get_attribute_value("resource-id")
    ...
    def content_desc(self):
        return self._get_attribute_value("content-desc")
